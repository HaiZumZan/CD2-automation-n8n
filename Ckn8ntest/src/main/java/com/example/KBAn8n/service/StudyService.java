...
public class StudyService {
    ...
    public String generateFlashcards(String fileName, String currentUser) {
        ...
        // 3. Lưu kết quả vào DB để ghi nhớ (Cá nhân hóa) - chỉ khi không phải lỗi
    ...
    public String evaluateFeynman(String fileName, String currentUser, String studentMessage, String persona) {
        ...
        payload.put("input", studentMessage); // THÊM DÒNG NÀY ĐỂ FIX LỖI N8N
    ...
    private String callN8n(Map<String, Object> payload) {
        try {
            ...
            try {
                ...
                errorMap.put("error", "Lỗi kết nối n8n: " + e.getMessage());
                return objectMapper.writeValueAsString(errorMap);
            } catch (Exception ex) {
                return "{\"error\": \"Lỗi kết nối n8n\"}";
            }
        }
    }
